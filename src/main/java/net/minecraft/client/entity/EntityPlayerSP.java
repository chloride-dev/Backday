...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public float prevRenderPitchHead, renderPitchHead;
    ...
    {
        MotionEvent event = new MotionEvent(posX, posY, posZ, rotationYaw, rotationPitch, onGround, MotionEvent.EventState.Pre);
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            MotionEvent eventPost = new MotionEvent(MotionEvent.EventState.Post);
