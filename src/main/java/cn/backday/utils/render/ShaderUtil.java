...
public class ShaderUtil implements MinecraftInterface {
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("Backday/shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "Backday/shaders/vertex.vsh");
    }
